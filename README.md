...
| :--- | :--- | :--- | :--- | :---: |
| [**antigravity-cli**](packages/antigravity-cli) | Google's agentic development platform (CLI companion) | `1.1.27_5211191891591168-1` | `Repo Only` | ![Repo Only](assets/dash-16.svg "Repo Only") |
...
| [**ungoogled-chromium-widevine-bin**](https://aur.archlinux.org/packages/ungoogled-chromium-widevine-bin) | A lightweight approach to removing Google web service dependency (with Widevine) | `152.0.7977.75-1` | `152.0.7977.75-1` | ![In sync with AUR](assets/check-16.svg "In sync with AUR") |
<!-- PACKAGES_TABLE_END -->
