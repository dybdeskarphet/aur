...
| :--- | :--- | :--- | :--- | :---: |
| [**antigravity-cli**](packages/antigravity-cli) | Google's agentic development platform (CLI companion) | `1.2.11_6016716732497920-1` | `Repo Only` | ![Repo Only](assets/dash-16.svg "Repo Only") |
...
| [**ungoogled-chromium-widevine-bin**](https://aur.archlinux.org/packages/ungoogled-chromium-widevine-bin) | A lightweight approach to removing Google web service dependency (with Widevine) | `153.0.8010.52-1` | `153.0.8010.52-1` | ![In sync with AUR](assets/check-16.svg "In sync with AUR") |
