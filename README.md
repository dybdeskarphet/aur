...
| :--- | :--- | :--- | :--- | :---: |
| [**gams**](https://aur.archlinux.org/packages/gams) | A high-level modeling system for mathematical optimization | `54.2.2-1` | `Not Published` | ![Not published](assets/dash-16.svg "Not published") |
| [**niri-companion**](https://aur.archlinux.org/packages/niri-companion) | Niri companion scripts: config generation, IPC extensions, workspace management | `5.0.0-1` | `Not Published` | ![Not published](assets/dash-16.svg "Not published") |
| [**ungoogled-chromium-widevine-bin**](https://aur.archlinux.org/packages/ungoogled-chromium-widevine-bin) | A lightweight approach to removing Google web service dependency (with Widevine) | `151.0.7922.108-1` | `Not Published` | ![Not published](assets/dash-16.svg "Not published") |
<!-- PACKAGES_TABLE_END -->
