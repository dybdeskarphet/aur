...
| :--- | :--- | :--- | :--- | :---: |
| [**antigravity-cli**](packages/antigravity-cli) | Google's agentic development platform (CLI companion) | `1.2.2_6061403484848128-1` | `Repo Only` | ![Repo Only](assets/dash-16.svg "Repo Only") |
...
| [**gams**](https://aur.archlinux.org/packages/gams) | A high-level modeling system for mathematical optimization | `54.4.0-1` | `54.3.1-1` | ![Ahead of AUR](assets/arrow-up-16.svg "Ahead of AUR") |
