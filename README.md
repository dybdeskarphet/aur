...
| :--- | :--- | :--- | :--- | :---: |
| [**antigravity-cli**](packages/antigravity-cli) | Google's agentic development platform (CLI companion) | `1.1.25_6680093607723008-1` | `Repo Only` | ![Repo Only](assets/dash-16.svg "Repo Only") |
